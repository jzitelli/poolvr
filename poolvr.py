...
def make_dist():
    ...
    os.makedirs(os.path.join(DIST_OUTPUT_DIR, 'node_modules', 'three.js', 'build'))
    shutil.copy(os.path.join('node_modules', 'three.js', 'build', 'three.js'), os.path.join(DIST_OUTPUT_DIR, 'node_modules', 'three.js', 'build'))
    shutil.copy(os.path.join('node_modules', 'three.js', 'build', 'three.min.js'), os.path.join(DIST_OUTPUT_DIR, 'node_modules', 'three.js', 'build'))
    os.makedirs(os.path.join(DIST_OUTPUT_DIR, 'node_modules', 'three.js', 'examples'))
    shutil.copytree(os.path.join('node_modules', 'three.js', 'examples', 'js'), os.path.join(os.path.join(DIST_OUTPUT_DIR, 'node_modules', 'three.js', 'examples', 'js')))
    shutil.copytree(os.path.join('node_modules', 'three.js', 'examples', 'models'), os.path.join(os.path.join(DIST_OUTPUT_DIR, 'node_modules', 'three.js', 'examples', 'models')))
    shutil.copytree(os.path.join('node_modules', 'three.js', 'examples', 'textures'), os.path.join(os.path.join(DIST_OUTPUT_DIR, 'node_modules', 'three.js', 'examples', 'textures')))
