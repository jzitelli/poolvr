...
def make_dist():
    ...
    os.makedirs(os.path.join(DIST_OUTPUT_DIR, 'node_modules', 'three', 'examples'))
    shutil.copytree(os.path.join('node_modules', 'three', 'examples', 'js'), os.path.join(os.path.join(DIST_OUTPUT_DIR, 'node_modules', 'three', 'examples', 'js')))
