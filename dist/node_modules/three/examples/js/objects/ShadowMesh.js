 ...
 *
 * slightly modified by jzitelli (https://github.com/jzitelli)
 *
 */

THREE.ShadowMesh = function ( mesh, material ) {
	...
	THREE.Mesh.call( this, mesh.geometry, material );
...
THREE.ShadowMesh.prototype.updateShadowMatrix = function ( plane, lightPosition4D ) {
...
THREE.ShadowMesh.prototype.updateMatrix = function() {
